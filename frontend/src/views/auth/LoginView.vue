<template>
  <div class="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl border-t-4 border-blue-600">
      <div>
        <!-- EDF Logo Placeholder or Title -->
        <h1 class="text-center text-4xl font-extrabold text-blue-900 tracking-tight">
          CPL <span class="text-orange-500">Hackathon</span>
        </h1>
